/**
 * Módulo para gestionar el resumen del personal
 * 
 * Genera y actualiza la visualización del resumen de personal por categorías
 */
const PersonalSummary = (function() {
    let contacts = [];

    /**
     * Establece la lista de contactos para el resumen
     * @param {Array} newContacts Lista de contactos
     */
    ...
    /**
     * Actualiza el resumen visual con estadísticas de personal
     */
    ...
    /**
     * Actualiza el contador y visibilidad de una categoría en el DOM
